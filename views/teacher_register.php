...
<article class="card" style="max-width: 65%; margin: 2rem auto;">
    ...
    <?php if ($showForm): ?>
        ...
        <div class="wizard-steps"
            style="display: flex; justify-content: space-around; margin: 1.5rem 1rem; border-bottom: 1px solid #e0e0e0; padding-bottom: 1rem;">
            <div id="step-tab-1" class="step-tab active"
                style="font-weight: bold; color: #007bff; display: flex; align-items: center; gap: 6px;">
                <span
                    style="display: inline-block; width: 26px; height: 26px; line-height: 26px; text-align: center; border-radius: 50%; background: #007bff; color: white;">1</span>
                <span>Account Basics</span>
            </div>
            <div id="step-tab-2" class="step-tab" style="color: #888; display: flex; align-items: center; gap: 6px;">
                <span
                    style="display: inline-block; width: 26px; height: 26px; line-height: 26px; text-align: center; border-radius: 50%; background: #ddd; color: #555;">2</span>
                <span>Teaching Profile</span>
            </div>
            <div id="step-tab-3" class="step-tab" style="color: #888; display: flex; align-items: center; gap: 6px;">
                <span
                    style="display: inline-block; width: 26px; height: 26px; line-height: 26px; text-align: center; border-radius: 50%; background: #ddd; color: #555;">3</span>
        ...
        <form id="teacherRegForm" method="post" style="padding: 1rem;">
            ...
            <div id="step-1" class="step-section">
                <h4 style="margin-bottom: 1rem; color: #333;"><i class="fa fa-user"></i> Step 1: Personal & Account Details
                </h4>
                ...
                <div class="grid">
                    ...
                    <label for="year_of_birth">Year of Birth <span style="color: red;">*</span>
                        <input type="number" id="year_of_birth" name="year_of_birth" min="1940" max="<?= date('Y') - 18 ?>"
                            required>
                    </label>
                </div>
                ...
                <div class="grid">
                    <label for="password">Create Password <span style="color: red;">*</span>
                        ...
                        <small id="err_password" class="field-error" style="color: #dc3545; display: none;">Password must be
                    ...
                    <label for="password_confirm">Confirm Password <span style="color: red;">*</span>
                        ...
                        <small id="err_password_confirm" class="field-error"
                            style="color: #dc3545; display: none;">Passwords do not match.</small>
                    </label>
                </div>

                <div style="display: flex; justify-content: flex-end; margin-top: 1.5rem;">
                    <button type="button" class="primary" onclick="goToStep(2)"
                        style="width: auto; padding: 0.6rem 2rem;">Next: Teaching Profile &rarr;</button>
                </div>
            </div>

            <!-- STEP 2: Teaching Specialization & Qualifications -->
            <div id="step-2" class="step-section" style="display: none;">
                <h4 style="margin-bottom: 1rem; color: #333;"><i class="fa fa-graduation-cap"></i> Step 2: Teaching
                    Specialization</h4>
                ...
                <div class="grid">
                    <label for="county">Preferred / Current County <span style="color: red;">*</span>
                        ...
                        <small id="err_county" class="field-error" style="color: #dc3545; display: none;">Please select a
                            county.</small>
                    </label>

                    <label for="qualification">Highest Academic Qualification <span style="color: red;">*</span>
                        <select id="qualification" name="qualification" onchange="toggleOtherQualification(this.value)"
                            required>
                            ...
                            <option value="Postgraduate Diploma in Education (PGDE)">Postgraduate Diploma in Education
                                (PGDE)</option>
                            <option value="Master's in Education (M.Ed)">Master's in Education (M.Ed)</option>
                            <option value="PhD">PhD</option>
                            <option value="Other">Other (Specify below)</option>
                        </select>
                        <small id="err_qualification" class="field-error" style="color: #dc3545; display: none;">Please
                            select your qualification.</small>
                    </label>
                </div>
                ...
                <div id="other_qualification_container" style="display: none; margin-bottom: 1rem;">
                    <label for="qualification_other">Please specify your qualification <span style="color: red;">*</span>
                        <input type="text" id="qualification_other" name="qualification_other"
                            placeholder="e.g. Higher National Diploma (HND), Certified Montessori">
                    </label>
                    <small id="err_qualification_other" class="field-error" style="color: #dc3545; display: none;">Please
                        specify your qualification.</small>
                </div>
                ...
                <label>Primary Teaching Curriculum & Level <span style="color: red;">*</span>
                    ...
                    <small id="err_grade_levels" class="field-error" style="color: #dc3545; display: none;">Please select a
                        teaching level.</small>
                </label>

                <label for="teaching_subjects">Teaching Subjects <span style="color: red;">*</span>
                    <input type="text" id="teaching_subjects" placeholder="e.g. Mathematics / Physics, CBC All Subjects"
                        name="teaching_subjects" required>
                    <small id="err_teaching_subjects" class="field-error" style="color: #dc3545; display: none;">Please
                        enter your teaching subject(s).</small>
                </label>
                ...
                <label for="tsc_number">TSC Number <small style="color: #666;">(Optional if not yet registered)</small>
                    ...
                    <small id="err_tsc_number" class="field-error" style="color: #dc3545; display: none;">Invalid TSC
                        Number. Leave blank if not registered.</small>
                </label>

                <div style="display: flex; justify-content: space-between; margin-top: 1.5rem;">
                    <button type="button" class="secondary" onclick="goToStep(1)"
                        style="width: auto; padding: 0.6rem 1.5rem;">&larr; Back</button>
                    <button type="button" class="primary" onclick="goToStep(3)"
                        style="width: auto; padding: 0.6rem 2rem;">Next: Experience & Bio &rarr;</button>
                </div>
            </div>

            <!-- STEP 3: Experience, Roles & Final Agreement -->
            <div id="step-3" class="step-section" style="display: none;">
                <h4 style="margin-bottom: 1rem; color: #333;"><i class="fa fa-briefcase"></i> Step 3: Experience &
                    Background</h4>

                <div class="grid">
                    <label for="years_of_experience">Teaching Experience (Years) <span style="color: red;">*</span>
                        <input type="number" id="years_of_experience" placeholder="0 for fresh graduates"
                            name="years_of_experience" min="0" max="45" value="0" required>
                    </label>
                ...
                <label for="responsibility">Roles Held <small style="color: #666;">(Optional)</small>
                    <input type="text" id="responsibility"
                        placeholder="e.g. Head of Department, Class Teacher, Games Master, Deputy Head"
                        name="responsibility">
                </label>

                <label for="brief_profile">Professional Bio <small style="color: #666;">(Optional)</small>
                    <textarea id="brief_profile"
                        placeholder="Brief statement about your teaching philosophy and core strengths."
                        name="brief_profile" rows="3"></textarea>
                </label>
                ...
                <label for="terms" style="text-align: left; margin-top: 1rem;">
                    ...
                    I have read and agree to the <a href="#privacyPolicyModal" data-toggle="modal">Privacy Policy</a> and <a
                        href="#termsConditionsModal" data-toggle="modal">Terms & Conditions</a>
                    <small id="err_terms" class="field-error" style="color: #dc3545; display: block; display: none;">You
                        must accept the terms to register.</small>
                </label>

                <div style="display: flex; justify-content: space-between; margin-top: 1.5rem;">
                    <button type="button" class="secondary" onclick="goToStep(2)"
                        style="width: auto; padding: 0.6rem 1.5rem;">&larr; Back</button>
                    <button type="submit" class="primary"
                        style="width: auto; padding: 0.6rem 2.5rem; background: #28a745; border-color: #28a745;">Complete
                        Registration</button>
                </div>
            </div>
            ...
            if (stepNumber === 2) {
                ...
                if (tsc.value.trim() !== '') {
                    ...
                    if (!tscPattern.test(tsc.value.trim()) || digits.length < 4 || digits.length > 8) {
                        setFieldError('tsc_number', 'Invalid TSC Number .');
                        hasError = true;
                    } else {
