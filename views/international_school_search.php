    ...
    <main class="content-pane"
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <p style="margin: 0; font-size: 0.85rem; color: #64748b;">
                Directory of accredited international, IB, and British curriculum institutions globally and across East
                Africa.
            </p>
        </div>
        ...
        <div
            ...
            <form method="GET" action="/schools/international" style="margin: 0;">
                ...
                <div
                    ...
                    <div>
                        <label
                            style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; margin-bottom: 4px; display: block;">School
                            / Keyword</label>
                    ...
                    <div>
                        <label
                            style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; margin-bottom: 4px; display: block;">Country</label>
                        <input type="text" name="country" value="<?= h($countryFilter) ?>"
                            placeholder="e.g. Kenya, UK, UAE, USA..."
                            style="width: 100%; box-sizing: border-box; margin: 0; height: 38px;">
                    </div>

                    <div>
                        <label
                            style="font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; margin-bottom: 4px; display: block;">City
                            / Town</label>
                        <input type="text" name="city" value="<?= h($cityFilter) ?>"
                            placeholder="e.g. Nairobi, London, Dubai..."
                            style="width: 100%; box-sizing: border-box; margin: 0; height: 38px;">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="sort" style="width: 100%; box-sizing: border-box; margin: 0; height: 38px;">
                            ...
                            <option value="name_desc" <?= ($sort === 'name_desc') ? 'selected' : '' ?>>School Name (Z
                                &rarr; A)</option>
                            <option value="country_asc" <?= ($sort === 'country_asc') ? 'selected' : '' ?>>Country (A
                                &rarr; Z)</option>
                            <option value="country_desc" <?= ($sort === 'country_desc') ? 'selected' : '' ?>>Country (Z
                                &rarr; A)</option>
                            <option value="city_asc" <?= ($sort === 'city_asc') ? 'selected' : '' ?>>City (A &rarr; Z)
                            </option>
                        </select>
                    </div>
                    ...
                    <div style="display: flex; gap: 6px;">
                        ...
                        <?php if ($search || $countryFilter || $cityFilter || $sort !== 'name_asc'): ?>
                            <a href="/schools/international?per_page=<?= $per_page ?>"
                        ...
                        <?php if (!empty($schools)): ?>
                            <?php foreach ($schools as $school): ?>
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            style="background: #f0fdfa; color: #0f766e; padding: 3px 8px; border-radius: 4px; font-size: 0.75rem; font-weight: 700; border: 1px solid #ccfbf1;">
