...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf($_POST['csrf_token'] ?? '')) {
        ...
        $error = "You have used your 1 free job posting on the Freemium plan. Please upgrade to Pro to post unlimited vacancies.";
    } else {
    ...
    <main class="content-pane">
        <div style="max-width: 760px; margin: 0 auto;">
            <div
                ...
                <div>
                    <a href="/school/dashboard"
                        style="background: #e2e8f0; color: #334155; font-size: 0.85rem; font-weight: 600; padding: 8px 14px; border-radius: 6px; display: inline-flex; align-items: center; gap: 6px; text-decoration: none;">
            ...
            <?php if ($successMessage): ?>
                <div
                    style="background: #dcfce7; border: 1px solid #86efac; color: #166534; padding: 12px 16px; border-radius: 8px; margin-bottom: 1.5rem; font-size: 0.9rem;">
            ...
            <?php if ($error): ?>
                <div
                    style="background: #fee2e2; border: 1px solid #fca5a5; color: #991b1b; padding: 12px 16px; border-radius: 8px; margin-bottom: 1.5rem; font-size: 0.9rem;">
            ...
            <?php if (!$canPost): ?>
                ...
                <div
                    style="background: white; border: 1px solid #fde68a; border-radius: 10px; padding: 2.5rem 1.75rem; text-align: center; box-shadow: 0 4px 12px rgba(217,119,6,0.08); margin-bottom: 2rem;">
                    <div
                        style="width: 56px; height: 56px; border-radius: 50%; background: #fef3c7; color: #d97706; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin: 0 auto 1rem;">
                        <i class="fa fa-lock"></i>
                    </div>
                    <h3 style="margin: 0 0 8px; color: #0f172a; font-size: 1.3rem;">Freemium Job Post Limit Reached</h3>
                    <p
                        style="margin: 0 0 1.5rem; font-size: 0.92rem; color: #64748b; max-width: 520px; margin-left: auto; margin-right: auto; line-height: 1.5;">
                        You have already posted your <strong>1 Free Teaching Vacancy</strong> on the Freemium plan. Upgrade
                        to <strong>Pro Recruiter</strong> to unlock unlimited vacancies and proactive teacher database
                        search!
                    </p>
                    <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
                        ...
                        <a href="/school/dashboard"
                            style="background: #f1f5f9; color: #475569; padding: 10px 20px; border-radius: 6px; font-weight: 600; text-decoration: none;">
                            Back to Dashboard
                        </a>
                    </div>
                </div>
            ...
            <?php else: ?>
                ...
                <?php if (!$isPro): ?>
                    <div
                        style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 6px; padding: 8px 14px; margin-bottom: 1.25rem; font-size: 0.82rem; color: #166534; display: flex; align-items: center; gap: 8px;">
                        <i class="fa fa-info-circle"></i>
                        <span><strong>Freemium Benefit:</strong> You are using your 1 Free Active Job Vacancy. Upgrade to Pro
                            anytime for unlimited postings!</span>
                    </div>
                <?php endif; ?>
                ...
                <div
                    ...
                    <form method="POST" action="/school/post-job" style="margin: 0;">
                        ...
                        <div style="margin-bottom: 1.25rem;">
                            ...
                            <input type="text" name="title" placeholder="e.g. High School Physics & Mathematics Teacher"
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <input type="date" name="deadline" min="<?= date('Y-m-d') ?>"
                                    style="width: 100%; box-sizing: border-box; background: white; padding: 8px 12px; border: 1px solid #cbd5e1; border-radius: 6px;">
                            </div>
                        </div>

                        <div style="display: flex; justify-content: flex-end; gap: 10px;">
                            <a href="/school/dashboard"
                                style="background: #f1f5f9; color: #475569; padding: 10px 18px; border-radius: 6px; font-weight: 600; text-decoration: none;">Cancel</a>
