...
<div class="landing-wrapper">
  ...
  <section class="landing-hero">
    <div class="hero-inner-wrapper">
      <div class="hero-box">
        <div class="hero-pill">
          <i class="fa-solid fa-graduation-cap"></i> Kenya's Premier Educator & School Linkage Platform
        </div>
        <h1 class="hero-title">
          Connecting Outstanding Educators with Leading Schools Across <span class="highlight">Kenya</span>
        </h1>
        <p class="hero-subtitle">
          Whether you are an institution recruiting vetted teaching talent, an educator advancing your career, or a student teacher seeking Teaching Practice (TP) placement — MwalimuLink bridges the gap.
        </p>
      ...
      <div class="stats-grid">
        <a href="/schools/public" class="stat-item">
          ...
          <div class="stat-content">
            ...
            <span class="stat-hint">Primary & Secondary across 47 Counties <i class="fa-solid fa-chevron-right" style="font-size:10px;"></i></span>
          </div>
        </a>
        ...
        <a href="/schools/private" class="stat-item">
          ...
          <div class="stat-content">
            ...
            <span class="stat-hint">Top-tier preparatory & high schools <i class="fa-solid fa-chevron-right" style="font-size:10px;"></i></span>
          </div>
        </a>
        ...
        <a href="/schools/international" class="stat-item">
          ...
          <div class="stat-content">
            ...
            <span class="stat-hint">British, IB & American curricula <i class="fa-solid fa-chevron-right" style="font-size:10px;"></i></span>
          </div>
        </a>
      </div>
    </div>
  ...
  <section class="landing-section">
    <div class="landing-container">
      <div class="section-header">
        ...
        <p class="section-desc">Tailored recruitment workflows, candidate discovery, and placement solutions built specifically for schools and educators.</p>
      </div>
      ...
      <div class="audience-grid">
        ...
        <div class="audience-card">
          <div>
            ...
            <p class="audience-text">
              Streamline faculty hiring with automated applicant tracking, verified subject credentials, and interview management.
            </p>
        ...
        <div class="audience-card">
          <div>
            ...
            <p class="audience-text">
              100% free lifetime membership for teachers. Get discovered by leading public and private schools across Kenya.
            </p>
            <ul class="audience-feature-list">
        ...
        <div class="audience-card">
          <div>
            ...
            <p class="audience-text">
              Accelerate your Teaching Practice. Connect directly with partner schools and secure formal placement without hassle.
            </p>
            <ul class="audience-feature-list">
    ...
    <div class="landing-container">
      ...
      <div class="steps-grid">
        <div class="step-card">
          ...
          <p class="step-desc">
            Institutions register their school profile and recruitment roles. Educators create a free account highlighting their subject combinations, TSC status, and academic experience.
          </p>
        </div>
        ...
        <div class="step-card">
          ...
          <p class="step-desc">
            Schools publish active job vacancies or TP placement capacities. Qualified educators browse listings and submit instant, secure applications directly to school administration.
          </p>
        </div>
        ...
        <div class="step-card">
          ...
          <p class="step-desc">
            Schools review candidate credentials, schedule in-person or virtual interviews, send real-time notification updates, and onboard educators with confidence.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="landing-section">
    <div class="landing-container">
      <div class="section-header">
        ...
        <p class="section-desc">A snapshot of accredited public, private, and international institutions listed on MwalimuLink.</p>
      </div>
      ...
      <div style="text-align: center;">
        <a href="/schools/public" class="btn-landing btn-landing-white" style="border: 1.5px solid var(--ml-primary); color: var(--ml-primary) !important;">
  ...
  <section class="landing-section landing-jobs">
    <div class="landing-container">
      <div class="section-header">
        ...
        <p class="section-desc">Sample openings from registered institutions looking for qualified Kenyan teaching talent.</p>
      </div>
      ...
      <div class="jobs-notice-box">
        <div class="jobs-notice-text">
          ...
          <span>Sample vacancies shown. Register or sign in to your Educator account to view all live postings and apply directly.</span>
        </div>
        <div style="display: flex; gap: 0.75rem;">
          <a href="/login/teacher" class="btn-landing btn-landing-primary" style="padding: 8px 16px; font-size: 0.86rem;">
            Teacher Login
          </a>
          <a href="/register/teacher" class="btn-landing btn-landing-white" style="padding: 8px 16px; font-size: 0.86rem; border: 1px solid var(--ml-slate-200);">
            Register Free
          </a>
        </div>
      </div>
  ...
  <section class="landing-section">
    <div class="landing-container">
      <div class="section-header">
        ...
        <p class="section-desc">Reliable institutional infrastructure connecting counties, curriculums, and teaching colleges.</p>
      </div>
      ...
      <div class="trust-grid">
        ...
        <div class="trust-item">
          ...
          <p class="trust-desc">Connect directly via official institutional email with zero recruiter intermediary fees.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="landing-cta-banner">
    <div class="landing-container">
      <div class="cta-box">
        ...
        <p class="cta-desc">
          Join thousands of educators and accredited schools already collaborating on Kenya's dedicated recruitment platform.
        </p>
