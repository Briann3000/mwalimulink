<div class="overseas-faq-wrapper">
  ...
  <section class="overseas-hero">
    <div class="overseas-container">
      ...
      <p class="overseas-hero-subtitle">
        Everything you need to know about qualifying for international schools, visa sponsorship, remuneration packages,
        and global relocation through MwalimuLink.
      </p>

      <!-- Live Search Box -->
      <div class="faq-search-wrapper">
        <i class="fa-solid fa-search search-icon"></i>
        <input type="text" id="overseasSearchInput"
          placeholder="Search keywords e.g. visa, qualifications, salaries, Middle East, UK..."
          oninput="filterOverseasFaqs()" style="padding-left: 44px !important; padding-right: 44px !important;">
        <button type="button" id="overseasClearBtn" class="clear-search-btn" onclick="clearOverseasSearch()"
          style="display: none;">
  ...
  <div class="overseas-container" style="padding-top: 2.5rem;">
    ...
    <div class="destination-grid">
      ...
      <div class="dest-card">
        <div class="dest-icon" style="background: #ccfbf1; color: #0f766e;"><i class="fa-solid fa-laptop-code"></i>
        </div>
        <h4>Remote & Online</h4>
    ...
    <div class="faq-controls-bar">
      <div class="faq-category-pills">
        ...
        <button class="cat-pill" onclick="setOverseasCategory('eligibility', this)"><i
            class="fa-solid fa-user-graduate"></i> Qualifications & Eligibility</button>
        <button class="cat-pill" onclick="setOverseasCategory('visa', this)"><i class="fa-solid fa-passport"></i> Visas
          & Relocation</button>
        <button class="cat-pill" onclick="setOverseasCategory('compensation', this)"><i
            class="fa-solid fa-money-bill-wave"></i> Salaries & Family</button>
        <button class="cat-pill" onclick="setOverseasCategory('application', this)"><i
            class="fa-solid fa-file-signature"></i> Application Timing</button>
      </div>
    ...
    <div class="faq-accordion-list" id="overseasAccordionList">
      ...
      <div class="faq-item" data-category="eligibility">
        ...
        <div class="faq-answer">
          <p>
            ...
            • <strong>Direct Access:</strong> Explore our curated directory of over 6,000 verified international schools
            worldwide, including direct headteacher/HR contact channels.<br>
            • <strong>Agency Placement:</strong> Access vetted recruitment partners collaborating with MwalimuLink to
            place Kenyan teachers in global institutions.<br><br>
            Ensure your profile is updated with your degree transcripts, TSC certificate, teaching subject mastery, and
      ...
      <div class="faq-item" data-category="eligibility">
        ...
        <div class="faq-answer">
          <p>Any qualified teacher with recognized academic credentials — regardless of nationality or current county of
            residence — can apply, provided they meet international school accreditation requirements.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="eligibility">
        ...
        <div class="faq-answer">
          <p>
            ...
            • <strong>Academic Degree:</strong> Bachelor of Education (B.Ed) or Bachelor's in a teaching subject +
            PGDE.<br>
            • <strong>Professional License:</strong> Active TSC registration or recognized international teaching
            license.<br>
            ...
            <em>Advantageous credentials:</em> IB (PYP/MYP/DP), Cambridge IGCSE, or American curriculum experience, and
      ...
      <div class="faq-item" data-category="eligibility">
        ...
        <div class="faq-answer">
          <p>Opportunities exist across the Middle East (UAE, Qatar, Oman, Saudi Arabia), East & West Africa, the United
            Kingdom, Western Europe, Southeast Asia (China, Vietnam, Thailand), South America, and remote international
            online academies.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="eligibility">
        ...
        <div class="faq-answer">
          <p>Classroom Teachers, STEM Specialists (Mathematics, Physics, Chemistry, Biology), ICT & Computer Science
            Educators, English/Literature Instructors, Special Needs & Inclusive Education Specialists, and Curriculum /
            Department Heads.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="visa">
        ...
        <div class="faq-answer">
          <p>In almost all established international schools, the hiring institution fully sponsors and processes your
            residency and work visa after formal contract signing. Standard requirements include certified degree
            transcripts, attested police clearance, medical fitness check, and valid passport.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="visa">
        ...
        <div class="faq-answer">
          <p>Yes. MwalimuLink collaborates with verified relocation consultants and agency partners who provide mock
            panel interviews, document attestation guidance, and pre-departure cultural orientation.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="visa">
        ...
        <div class="faq-answer">
          <p>Relocating involves adapting to different cultural norms, diverse student body demographics, international
            curricula (such as IB or Cambridge), and weather adjustments. We recommend thorough research on your
            destination country's expatriate laws before contract signing.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="compensation">
        <button class="faq-trigger" onclick="toggleFaq(this)">
          ...
          <span class="faq-question">9. What are typical salaries and compensation packages for international
            teachers?</span>
          <i class="fa-solid fa-chevron-down faq-chevron"></i>
        </button>
        <div class="faq-answer">
          <p>
            International packages typically range from <strong>$1,200 to $4,500 USD per month</strong> (approx. KES
            155,000 – KES 580,000) depending on experience, subject specialty, and country tier.<br>
      ...
      <div class="faq-item" data-category="compensation">
        ...
        <div class="faq-answer">
          <p>Yes. Tier-1 and Tier-2 international schools routinely sponsor spousal residency visas and provide free or
            heavily subsidized school tuition for up to 2 dependent children. Always disclose your family status early
            in the interview stage.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="compensation">
        ...
        <div class="faq-answer">
          <p><strong>CAUTION:</strong> Legitimate international schools never charge teachers for interviews or job
            offers. On MwalimuLink, browsing and applying is free. Beware of external fraudulent agencies that demand
            large sums for "guaranteed visas".</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="application">
        <button class="faq-trigger" onclick="toggleFaq(this)">
          ...
          <span class="faq-question">12. When is the peak recruitment season for international teaching
            contracts?</span>
          <i class="fa-solid fa-chevron-down faq-chevron"></i>
        </button>
        <div class="faq-answer">
          <p>
            • <strong>Primary Cycle (August/September Starts):</strong> Peak hiring is between <strong>January and
              May</strong>.<br>
            • <strong>Secondary Cycle (January Starts):</strong> Hiring takes place between <strong>September and
              November</strong>.<br>
      ...
      <div class="faq-item" data-category="application">
        ...
        <div class="faq-answer">
          <p>A comprehensive international teaching portfolio should include: a 2-page concise CV, tailored cover
            letter, certified university degree transcripts, TSC certificate, 2 written supervisor reference letters,
            passport bio-data copy, and a 2-3 minute recorded video lesson introduction.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="application">
        ...
        <div class="faq-answer">
          <p>Yes. You can filter our International Schools directory by country and apply directly to schools in your
            target destination. Flexibility across 2 or 3 countries significantly increases your placement speed.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="application">
        ...
        <div class="faq-answer">
          <p>MwalimuLink is an educational career platform and directory network. We connect teachers directly with
            school administrators and vetted recruitment partners, providing directory access and profile verification.
          </p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="application">
        <button class="faq-trigger" onclick="toggleFaq(this)">
          ...
          <span class="faq-question">16. How does MwalimuLink safeguard educator data in international
            transmissions?</span>
          <i class="fa-solid fa-chevron-down faq-chevron"></i>
        </button>
        <div class="faq-answer">
          <p>Your resume and contact information are only made available to vetted, verified institutional
            representatives. You maintain complete control over your profile visibility from your privacy settings.</p>
        </div>
      </div>
      ...
      <div class="faq-item" data-category="application">
        ...
        <div class="faq-answer">
          <p>Reach out directly to our international liaison desk at <a href="mailto:infomwalimulink@gmail.com"
              style="color: #0f766e; font-weight: 700;">infomwalimulink@gmail.com</a> or submit an inquiry via our <a
              href="/contacts" style="color: #0f766e; font-weight: 700;">Contact Support Desk</a>.</p>
        </div>
      </div>
    ...
    <div class="faq-support-banner">
      <div class="banner-left">
        ...
        <div>
          ...
          <p>Browse our curated directory of accredited international schools across Africa, the Middle East, Asia, and
            Europe.</p>
        </div>
      </div>
      <div class="banner-actions">
        <a href="/schools/international" class="btn-ask-support"><i class="fa-solid fa-search"></i> Browse International
          Schools</a>
