...
<article class="card" style="max-width: 65%; margin: 2rem auto;">
    <header>
        ...
        <p style="text-align: center; margin-bottom: 0;">Register your institution to search teachers and post job
            vacancies.</p>
    </header>
    ...
    <?php if ($showForm): ?>
        ...
        <div class="wizard-steps"
            ...
            <div id="school-tab-1" class="step-tab active"
        ...
        <form id="schoolRegForm" method="POST" style="padding: 1rem;">
            ...
            <div id="school-step-1" class="step-section">
                <h4 style="margin-bottom: 1rem; color: #333;"><i class="fa fa-school"></i> Step 1: Institution Information
                </h4>
                ...
                <div style="display: flex; justify-content: flex-end; margin-top: 1.5rem;">
                    <button type="button" class="primary" onclick="goToSchoolStep(2)"
                        style="width: auto; padding: 0.6rem 2rem;">Next: Contact & Security &rarr;</button>
                </div>
            </div>

            <!-- STEP 2: Contact Person & Account Security -->
            <div id="school-step-2" class="step-section" style="display: none;">
                <h4 style="margin-bottom: 1rem; color: #333;"><i class="fa fa-lock"></i> Step 2: Contact Person & Security
                </h4>
                ...
                <div class="grid">
                    ...
                    <label for="phone_number">Official Phone Number (M-Pesa) <span style="color: red;">*</span>
                        <input type="tel" id="phone_number" placeholder="e.g. 0712345678 or 0112345678" name="phone_number"
                            required>
                    </label>
                </div>

                <label for="contact_person">Contact Person & Designation <small style="color: #666;">(e.g. Principal,
                        Headteacher, Director)</small>
                    <input type="text" id="contact_person" placeholder="e.g. Mrs. Mary Kariuki - Headteacher"
                        name="contact_person">
                </label>
                ...
                <label for="terms" style="text-align: left; margin-top: 1rem;">
                    ...
                    <small id="err_school_terms" class="field-error" style="color: #dc3545; display: none;">You must accept
                        the terms to continue.</small>
                </label>

                <div style="display: flex; justify-content: space-between; margin-top: 1.5rem;">
                    <button type="button" class="secondary" onclick="goToSchoolStep(1)"
                        style="width: auto; padding: 0.6rem 1.5rem;">&larr; Back</button>
                    <button type="submit" class="primary"
                        style="width: auto; padding: 0.6rem 2.5rem; background: #28a745; border-color: #28a745;">Register &
                        Proceed to Subscription</button>
                </div>
            </div>

            <p style="text-align: center; margin-top: 1.5rem;">Already registered? <a href="/login/school">Login here</a>
            </p>
        </form>
    <?php endif; ?>
